...
print (commonlist)
''' 2. Python program to check if a set is a subset of anothe'''
s1={1,2,3,4,5}
s2={4,5}
if s2.issubset(s1):
...
''' 3. Python program to find the union of two sets'''
T1 = (1, 9, 1, 6, 3, 4, 5, 1, 1, 2, 5, 6, 7, 8, 9, 2)
T2 = ["Jaydeepsinh", "Bhupatsinh", "Shardaba", "Pratikshaba", "Gulabba", "Jaydeepsinh"]
s1 = set(T1)
print (s1)
s2 = set(T2)
print (s2)