...
----------------------------------------------------------------------
1                          buffer_info()
                        Returns a tuple (address, length) giving the current
                        memory address and the length in elements of the
                        buffer used to hold the array’s contents.
----------------------------------------------------------------------
2                          count(x)
                        Returns the number of occurrences of x in the
                        array.
----------------------------------------------------------------------
3                          index(x[, start[, stop]])
                        Returns the smallest index where x is found in the
                        array. Optional start and stop arguments can
                        specify a sub-range to search.
----------------------------------------------------------'''
...
----------------------------------------------------------------------
2                          byteswap()
                      "Byteswaps" all items of the array, useful for
                      reading data from a file written on a machine with a
...
----------------------------------------------------------------------
1                          frombytes(buffer)
                      Appends items from the bytes-like object,
                      interpreting its content as an array of machine
                      values.
----------------------------------------------------------------------
2                          tobytes()
...
----------------------------------------------------------------------
3                          fromfile(f, n)
                      Reads n items from the file object f and appends
                      them to the array.
----------------------------------------------------------------------
4                          tofile(f)
...
----------------------------------------------------------------------
7                          fromunicode(s)
                      Extends the array with data from the given Unicode
                      string. The array must have type code 'u'.
----------------------------------------------------------------------
8                          tounicode()
                      Converts the array to a Unicode string. The array
                      must have type code 'u'.
----------------------------------------------------------
'''
...
''' Exercise Programs
Python program find difference between each number in the array and the average of all
numbers
